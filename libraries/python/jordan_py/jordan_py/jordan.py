...
TASK_STATE = '{}'
UPDATE_TASK_STATE_RESOURCE = CLIENT_NAMESPACE + TASK_ID + 'task/' + TASK_STATE
STATUS_RESOURCE = CLIENT_NAMESPACE + TASK_ID + 'status'
MESSAGE_RESOURCE = CLIENT_NAMESPACE + TASK_ID + 'message'
MESSAGE_ID = '{}/'
MESSAGE_STATE = '{}'
UPDATE_MESSAGE_STATE_RESOURCE = CLIENT_NAMESPACE + TASK_ID + 'message/' + MESSAGE_ID + MESSAGE_STATE
CLIENT_ID = '{}/'
