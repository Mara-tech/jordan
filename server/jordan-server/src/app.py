...
@client_ns.route('/<int:task_id>/task/<string:task_state>')
...
@client_ns.route('/<int:task_id>/message/<int:message_id>/<string:message_state>')
@client_ns.param('task_id', 'The task identifier', default=123)
...
@admin_ns.route('/generic/<int:generic_id>')
